 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}Adhesion" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "LstAdhesions")
public class LstAdhesions {

    @XmlElement(name = "Adhesion", required = true)
    protected List<Adhesion> adhesion;
    ...
    public List<Adhesion> getAdhesion() {
        if (adhesion == null) {
            adhesion = new ArrayList<Adhesion>();
        }
