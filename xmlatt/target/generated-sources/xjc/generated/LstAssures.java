 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}Assure" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "LstAssures")
public class LstAssures {

    @XmlElement(name = "Assure", required = true)
    protected List<Assure> assure;
     ...
     * This is why there is not a <CODE>set</CODE> method for the assure property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAssure().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Assure> getAssure() {
        if (assure == null) {
            assure = new ArrayList<Assure>();
        }
        return this.assure;
    }
